...
- `przyklady/`: `lancuch02.py` (CSV) i trzy przykłady kanoniczne: `przysiad.py`, `robot_kroczacy.py` (compass gait) → `piesek.py` (czworonóg robiący przysiady; `dt=0.0005`), `dron.py` (kwadrokopter); `lancuch.blend` to scena Blendera.
